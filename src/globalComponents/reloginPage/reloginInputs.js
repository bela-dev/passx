...
function ReloginInputs(props) {
    ...
    return <>
        <div className={"relogin-input " + reloginInputClassName} ref={reloginEl}>
                {reloginInputClassName == "phone" ? <ReloginPhoneInput passwordLength={length} onFinish={finish}/> : inputFields}
            </div>
    </>;
}

export default ReloginInputs;